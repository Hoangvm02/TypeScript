    ...
    <div className="flex flex-wrap xl:mx-auto xl:container">
      <div className="w-full relative lg:w-1/2 xl:mt-10 mb-10 2xl:pr-24 2xl:pl-0 xl:pl-12 pl-0">
        ...
        <div className="w-full flex flex-col items-start xl:justify-start relative z-20 xl:px-0 px-4 xl:py-0 py-4">
          <div className="w-full 2xl:pl-48 xl:pt-1">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-gray-800">Luxiwood</h1>
            <div className="w-full md:w-10/12 mt-3">
              <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider">Xin chào mọi người</h2>
              <div className="mt-4 md:mt-8">
                <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Địa chỉ</h2>
                <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">118B LÊ QUANG ĐẠO - P.PHÚ ĐÔ - Q.NAM TỪ LIÊM</h2>
              </div>
              <div className="mt-4 md:mt-8">
                <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Phone</h2>
              ...
              <div className="mt-4 md:mt-8">
                ...
                <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">hoangvm02@gmail.com</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 xl:pt-10 lg:pl-24">
        <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-indigo-700">LIÊN HỆ</h1>
          <div className="w-full 2xl:w-8/12 mt-3" role="form">
            <h2 className="text-gray-800 dark:text-white text-base md:text-lg leading-8 tracking-wider">Mời Bạn nhập thông tin</h2>
            <div className="mt-4 md:mt-8">
